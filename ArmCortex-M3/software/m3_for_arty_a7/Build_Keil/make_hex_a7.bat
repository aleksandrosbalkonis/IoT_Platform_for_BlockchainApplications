...
call fromelf --vhx --32x1 --output bram_a7.hex V:\software\m3_for_arty_a7\Build_Keil\objects\m3_for_arty_a7.axf
@REM - File to merge SW into bitstream
@REM axf file will work, but has to be renamed to .elf for updatemem to work
copy  V:\software\m3_for_arty_a7\Build_Keil\objects\m3_for_arty_a7.axf bram_a7.elf
@REM - File to load into DAPLink QSPI simulation
call fromelf --vhx --8x1  --output qspi_a7.hex V:\software\m3_for_arty_a7\Build_Keil\objects\m3_for_arty_a7.axf
@REM - Files to load onto DAPLink QSPI board
call fromelf --bin        --output qspi_a7.bin V:\software\m3_for_arty_a7\Build_Keil\objects\m3_for_arty_a7.axf

@REM - Copy the files to the relevant directories of the hardware project
copy bram_a7.* V:\hardware\m3_for_arty_a7\m3_for_arty_a7
copy qspi_a7.hex V:\hardware\m3_for_arty_a7\testbench
