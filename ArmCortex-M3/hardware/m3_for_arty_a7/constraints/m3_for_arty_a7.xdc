...
set_property IOSTANDARD LVCMOS33 [get_ports {dip_switches_4bits_tri_*}]
set_property IOSTANDARD LVCMOS33 [get_ports {push_buttons_4bits_tri_*}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_4bits_tri_*}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb_led_tri_*}]
set_property IOSTANDARD LVCMOS33 [get_ports {esp_*}]
...
create_generated_clock -name cclk -source        [get_pins -hier -regexp m3_for_arty_a7_i/axi_quad_spi_0/.*STARTUP2_7SERIES_inst/USRCCLKO] \
                                  -combinational [get_pins -hier -regexp m3_for_arty_a7_i/axi_quad_spi_0/.*STARTUP2_7SERIES_inst/USRCCLKO]
...
set_max_delay -from [get_clocks cclk] -to [get_clocks -include_generated_clocks qspi_clk] -datapath_only 9.0
set_max_delay -from [get_clocks -include_generated_clocks qspi_clk] -to [get_clocks cclk] -datapath_only 9.0
